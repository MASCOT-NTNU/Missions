...
datapath = "/home/ahomea/y/yaoling/MASCOT/Missions/Data/"
figpath = '/home/ahomea/y/yaoling/MASCOT/Missions/fig/'
...
# for i in range(len(xauv_new)):
    ...
    xe, ye, ze = rotate_z(x_eye, y_eye, z_eye, -i * .01)
    fig.update_layout(
        scene={
            'aspectmode': 'manual',
    ...
    # fig.write_image(figpath + "T_{:03d}.png".format(i), width=1980, height=1080)
