...
class AuvHandler:
    def __init__(self,node_name,configpath = "null"):
        self.init = False
        ...
        try:
            self.sensors = rospy.get_param("/" + node_name + "/sensors","[Water Quality Sensor,Water Quality Sensor]")
        ...
        self.ref_pub_ = rospy.Publisher("/IMC/In/Reference", Reference, queue_size = 10)
        self.entityList_pub_ = rospy.Publisher("/IMC/In/EntityList", EntityList, queue_size = 10)
        self.logBookEntry_pub_  = rospy.Publisher("/IMC/In/LogBookEntry", LogBookEntry, queue_size = 10)
        ...
        self.temperature_filtered_pub_ = rospy.Publisher("/Vehicle/Out/Temperature_filtered", Temperature,queue_size = 10 )
        self.salinity_filtered_pub_ = rospy.Publisher("/Vehicle/Out/Salinity_filtered", Salinity,queue_size = 10 )
        self.estimatedState_filtered_pub_ = rospy.Publisher("/Vehicle/Out/EstimatedState_filtered", EstimatedState, queue_size = 10)
